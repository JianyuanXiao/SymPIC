...
(Z0 = xz0);
(Z1 = xz1);
	c_cal_fun_f0 ( f0_x0 , rx0 , ixx0 );
	c_cal_fun_f0 ( f0_y0 , ry0 , ixy0 );
	c_cal_fun_f0 ( f0_z0 , rz0 , ixz0 );
	c_cal_fun_f0 ( f0_x1 , rx1 , ixx1 );
	c_cal_fun_f0 ( f0_y1 , ry1 , ixy1 );
	c_cal_fun_f0 ( f0_z1 , rz1 , ixz1 );
	c_cal_fun_f1 ( f1_x0 , rx0 , ixx0 );
	c_cal_fun_f1 ( f1_y0 , ry0 , ixy0 );
	c_cal_fun_f1 ( f1_z0 , rz0 , ixz0 );
	c_cal_fun_f1 ( f1_x1 , rx1 , ixx1 );
	c_cal_fun_f1 ( f1_y1 , ry1 , ixy1 );
	c_cal_fun_f1 ( f1_z1 , rz1 , ixz1 );
	c_cal_fun_if1 ( if1_x0 , rx0 , ixx0 );
	c_cal_fun_if1 ( if1_y0 , ry0 , ixy0 );
	c_cal_fun_if1 ( if1_z0 , rz0 , ixz0 );
	c_cal_fun_if1 ( if1_x1 , rx1 , ixx1 );
	c_cal_fun_if1 ( if1_y1 , ry1 , ixy1 );
	c_cal_fun_if1 ( if1_z1 , rz1 , ixz1 );
	double  Ex1 = 	c_get_E1_local_opt ( shE0 , f1_x1 , f0_y1 , f0_z1 , 0 , 0 ) ;
	double  Ey1 = 	c_get_E1_local_opt ( shE0 , f1_y1 , f0_z1 , f0_x1 , 1 , 1 ) ;
	double  Ez1 = 	c_get_E1_local_opt ( shE0 , f1_z1 , f0_x1 , f0_y1 , 2 , 2 ) ;
	static int  i0 = 0 ;
	double  Resx ;
	double  Resy ;
	double  Resz ;
...
(B0y_intzX1Y1Z0Z1 = 	c_get_B1_local_opt ( shB0 , if1_z0 , if1_z1 , f1_x1 , f0_y1 , 2 , 1 ));
	double  B0z_intyX1Y0Z0Y1 ;
(B0z_intyX1Y0Z0Y1 = 	c_get_B1_local_opt ( shB0 , if1_y0 , if1_y1 , f0_z0 , f1_x1 , 1 , 2 ));
...
(B0x_intzX1Y1Z0Z1 = 	c_get_B1_local_opt ( shB0 , if1_z0 , if1_z1 , f0_x1 , f1_y1 , 2 , 0 ));
	...
	{
{
	...
	int  ixy2 = 	(  Midy2 - Midy ) ;
	int  ixz2 = 	(  Midz2 - Midz ) ;
	c_cal_fun_f0 ( f0_x2 , rx2 , ixx2 );
	c_cal_fun_f0 ( f0_y2 , ry2 , ixy2 );
	c_cal_fun_f0 ( f0_z2 , rz2 , ixz2 );
	c_cal_fun_f1 ( f1_x2 , rx2 , ixx2 );
	c_cal_fun_f1 ( f1_y2 , ry2 , ixy2 );
	c_cal_fun_f1 ( f1_z2 , rz2 , ixz2 );
	c_cal_fun_if1 ( if1_x2 , rx2 , ixx2 );
	c_cal_fun_if1 ( if1_y2 , ry2 , ixy2 );
	c_cal_fun_if1 ( if1_z2 , rz2 , ixz2 );
	c_cal_fun_df0 ( df0_x2 , rx2 , ixx2 );
	c_cal_fun_df0 ( df0_y2 , ry2 , ixy2 );
	c_cal_fun_df0 ( df0_z2 , rz2 , ixz2 );
	c_cal_fun_dif1 ( dif1_x2 , rx2 , ixx2 );
	c_cal_fun_dif1 ( dif1_y2 , ry2 , ixy2 );
	c_cal_fun_dif1 ( dif1_z2 , rz2 , ixz2 );
...
(B1z_intxX1Y1Z1X2 = 	c_get_B1_local_opt ( shB1 , if1_x1 , if1_x2 , f1_y1 , f0_z1 , 0 , 2 ));
...
(B1x_intyX2Y1Z1Y2 = 	c_get_B1_local_opt ( shB1 , if1_y1 , if1_y2 , f1_z1 , f0_x2 , 1 , 0 ));
	double  B1y_intxX1Y1Z1X2 ;
(B1y_intxX1Y1Z1X2 = 	c_get_B1_local_opt ( shB1 , if1_x1 , if1_x2 , f0_y1 , f1_z1 , 0 , 1 ));
...
(B1z_intx_xX1Y1Z1X2 = 	c_get_E1_local_opt ( shB1 , dif1_x2 , f0_z1 , f1_y1 , 2 , 0 ));
...
(B1y_intx_xX1Y1Z1X2 = 	c_get_E1_local_opt ( shB1 , dif1_x2 , f1_z1 , f0_y1 , 1 , 0 ));
...
(B1x_inty_yX2Y1Z1Y2 = 	c_get_E1_local_opt ( shB1 , dif1_y2 , f0_x2 , f1_z1 , 0 , 1 ));
