	...
	goto beg_prog;	core_fun:
{
	...
	int  Midx = 	c_mass_floorx ( (particle_head_general)[0] ) ;
	int  Midy = 	c_mass_floorx ( (particle_head_general)[1] ) ;
	int  Midz = 	c_mass_floorx ( (particle_head_general)[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
...
}}}}}	double   a_f  [	(  1 * 3 )];0;
{
	...
	double  Midx0 = 	c_mass_floorx ( xx0 ) ;
	double  Midy0 = 	c_mass_floorx ( xy0 ) ;
	double  Midz0 = 	c_mass_floorx ( xz0 ) ;
	double  Midx1 = 	c_mass_floorx ( xx1 ) ;
	double  Midy1 = 	c_mass_floorx ( xy1 ) ;
	double  Midz1 = 	c_mass_floorx ( xz1 ) ;
	...
	{
{
	...
	double  xy2 = Y2 ;
	double  xz2 = Z2 ;
	int  Midx2 = 	c_mass_floorx ( xx2 ) ;
	int  Midy2 = 	c_mass_floorx ( xy2 ) ;
	int  Midz2 = 	c_mass_floorx ( xz2 ) ;
