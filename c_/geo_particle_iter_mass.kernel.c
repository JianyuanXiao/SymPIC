...
void  c_geo_rel_1st_fwd_small_grids_scmc_kernel (double *  inoutput ,int *  xyzw ,double *  cu_cache ,int *  cu_xyzw ,int *  xoffset ,int *  yoffset ,int *  zoffset ,double *  fieldE ,double *  fieldB ,double *  fieldB1 ,double *  LFoutJ ,long  XLEN ,long  YLEN ,long  ZLEN ,int  ovlp ,long  numvec ,int  num_ele ,long  grid_cache_len ,long  cu_cache_length ,double  DELTA_X ,double  DELTA_Y ,double  DELTA_Z ,double  Mass0 ,double  Charge0 ,double  Deltat ,double  Tori_X0 ,double  Solve_Err ,long  scmc_internal_g_idy ,long  scmc_internal_g_ylen ){
	...
	double   shB0  [375];	double   shB1  [375];	double   shE0  [375];	double   shJ0  [375];	long  allgid = idy ;
	...
	int  cu_load = (cu_xyzw)[	(  4 * allgid )] ;
{
	...
	int  Midx = 	c_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[0] ) ;
	int  Midy = 	c_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[1] ) ;
	int  Midz = 	c_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
	...
	{
{
	...
	{
(((local_particle_head)[0])[	(  	(  inner_step * 6 ) + inner_g )] = (	(  	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ) + 	(  iba_tmp * 6 ) ))[	(  	(  inner_step * 6 ) + inner_g )]);
}}}}}	double   a_f  [1][3];0;
{
	long  g ;
	...
	{
{
	...
	for ((inner_g = 0) ; 	(  inner_g < 6 ) ; (inner_g = 	(  inner_g + 1 )))
	{
((	(  	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ) + 	(  iba_tmp * 6 ) ))[	(  	(  inner_step * 6 ) + inner_g )] = ((local_particle_head)[0])[	(  	(  inner_step * 6 ) + inner_g )]);
}}}}0;
}}{
	long  Gll_P9918 ;
...
((	(  LFoutJ + 	(  	(  375 * 	(  idy * 	(  	(  XLEN + 	(  2 * ovlp ) ) * 	(  	(  YLEN + 	(  2 * ovlp ) ) * 	(  ZLEN + 	(  2 * ovlp ) ) ) ) ) ) + 	(  0 + 	(  375 * 	(  	(  Midx + ovlp ) + 	(  	(  XLEN + 	(  2 * ovlp ) ) * 	(  	(  Midy + ovlp ) + 	(  	(  YLEN + 	(  2 * ovlp ) ) * 	(  Midz + ovlp ) ) ) ) ) ) ) ) ))[Gll_P9918] = (shJ0)[Gll_P9918]);
	...
	double  grid_geo_z = 	(  DELTA_Z / 	(  DELTA_X * DELTA_Y ) ) ;
	double  XO = (xoffset)[idy] ;
	int  Midx = 	c_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[0] ) ;
	int  Midy = 	c_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[1] ) ;
	int  Midz = 	c_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
	double  Mass = 1.00000000000000000e+00 ;
	...
	{
{
	...
	for ((inner_g = 0) ; 	(  inner_g < 6 ) ; (inner_g = 	(  inner_g + 1 )))
	{
(((local_particle_head)[0])[	(  	(  inner_step * 6 ) + inner_g )] = (	(  	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ) + 	(  iba_tmp * 6 ) ))[	(  	(  inner_step * 6 ) + inner_g )]);
}}}}}	double   a_f  [1][3];0;
{
	long  g ;
	for ((g = 0) ; 	(  g < numcp ) ; (g = 	(  g + 1 )))
	...
	{
{
	...
	for ((inner_g = 0) ; 	(  inner_g < 6 ) ; (inner_g = 	(  inner_g + 1 )))
	{
((	(  	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ) + 	(  iba_tmp * 6 ) ))[	(  	(  inner_step * 6 ) + inner_g )] = ((local_particle_head)[0])[	(  	(  inner_step * 6 ) + inner_g )]);
}}}}0;
}}{
	long  Gll_P9918 ;
	for ((Gll_P9918 = 0) ; 	(  Gll_P9918 < 375 ) ; (Gll_P9918 = 	(  Gll_P9918 + 1 )))
...
}(((a_f)[	(  g % 1 )])[2] = 	(  	(  Charge * Ez1 ) + 	(  Mass * 	(  	pow ( DELTA_Z , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	(  	(  	(  -1.00000000000000000e+00 * Z0 ) + Z1 ) * 	(  	pow ( 	(  1.00000000000000000e+00 + 	(  	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_X , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * X0 ) + X1 ) , 2 ) ) ) ) + 	(  	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_Y , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * Y0 ) + Y1 ) , 2 ) ) ) ) + 	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_Z , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * Z0 ) + Z1 ) , 2 ) ) ) ) ) ) ) , -1.00000000000000000e+00 ) * 	sqrt ( 	(  1.00000000000000000e+00 + 	(  	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_X , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * X0 ) + X1 ) , 2 ) ) ) ) + 	(  	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_Y , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * Y0 ) + Y1 ) , 2 ) ) ) ) + 	(  -1.00000000000000000e+00 * 	(  	pow ( DELTA_Z , 2 ) * 	(  	pow ( DELTAT , -2 ) * 	pow ( 	(  	(  -1.00000000000000000e+00 * Z0 ) + Z1 ) , 2 ) ) ) ) ) ) ) ) ) ) ) ) ) ));
}}}{
	long  g ;
	for ((g = 0) ; 	(  g < numcp ) ; (g = 	(  g + 1 )))
	{
