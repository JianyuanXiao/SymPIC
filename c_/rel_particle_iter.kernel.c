	...
	goto beg_prog;	core_fun:
{
	...
	int  Midx = 	c_floory ( (particle_head_general)[0] ) ;
	int  Midy = 	c_floory ( (particle_head_general)[1] ) ;
	int  Midz = 	c_floory ( (particle_head_general)[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
	...
	int  total_idx = 	(  3 * 	(  5 * 	(  xyzy + 	(  5 * xyzz ) ) ) ) ;
{
	...
	long  gMYGEN56 = 0 ;
	for (0 ; 	(  	(  gMYGEN56 + 	(  idx * 1 ) ) < load0 ) ; (gMYGEN56 = 	(  gMYGEN56 + 	(  1 * xlen ) )))
	{
	long  iba_tmp = 	(  	(  idx * 1 ) + gMYGEN56 ) ;
	long  numcp = 1 ;
...
}}}}}	double   a_f  [	(  1 * 3 )];0;
{
	...
	double  Midx0 = 	c_floory ( xx0 ) ;
	double  Midy0 = 	c_floory ( xy0 ) ;
	double  Midz0 = 	c_floory ( xz0 ) ;
	double  Midx1 = 	c_floory ( xx1 ) ;
	double  Midy1 = 	c_floory ( xy1 ) ;
	double  Midz1 = 	c_floory ( xz1 ) ;
	...
	{
{
	...
	double  xy2 = Y2 ;
	double  xz2 = Z2 ;
	int  Midx2 = 	c_floory ( xx2 ) ;
	int  Midy2 = 	c_floory ( xy2 ) ;
	int  Midz2 = 	c_floory ( xz2 ) ;
