	...
	{
{
	...
	{
((	(  local_temp_particle_cache + 	(  0 * 6 ) ))[	(  	(  inner_step * 1 ) + inner_g )] = (	(  cu_cache + 	(  	(  	(  cu_cache_length * idy ) + i ) * 6 ) ))[	(  	(  inner_step * 1 ) + inner_g )]);
}}}}}	for (j=0 ; 	(  j < numcp ) ; j++)
	{
	long  allid = 	(  i + j ) ;
	...
	int  wrted_grid = 0 ;
	if (  	(  	c_is_in ( xyzx , 0 , XLEN ) && 	(  	c_is_in ( xyzy , 0 , YLEN ) && 	c_is_in ( xyzz , 0 , ZLEN ) ) )  ){  
	...
	{
{
	...
	for ((inner_g = 0) ; 	(  inner_g < 1 ) ; (inner_g = 	(  inner_g + 1 )))
	{
((	(  inoutput + 	(  6 * 	(  	(  allid_grid * grid_cache_len ) + gridload ) ) ))[	(  	(  inner_step * 1 ) + inner_g )] = (	(  local_temp_particle_cache + 	(  j * 6 ) ))[	(  	(  inner_step * 1 ) + inner_g )]);
}}}}(wrted_grid = 1);
	...
	{
{
	...
	for ((inner_g = 0) ; 	(  inner_g < 1 ) ; (inner_g = 	(  inner_g + 1 )))
	{
((	(  cu_cache + 	(  6 * 	(  	(  idy * cu_cache_length ) + cur_cu_load ) ) ))[	(  	(  inner_step * 1 ) + inner_g )] = (	(  local_temp_particle_cache + 	(  j * 6 ) ))[	(  	(  inner_step * 1 ) + inner_g )]);
