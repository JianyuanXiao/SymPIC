	...
	goto beg_prog;	core_fun:
{
	...
	int  Midx = 	openmp_floorx ( (particle_head_general)[0] ) ;
	int  Midy = 	openmp_floorx ( (particle_head_general)[1] ) ;
	int  Midz = 	openmp_floorx ( (particle_head_general)[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
	...
	int  total_idx = 	(  3 * 	(  5 * 	(  xyzy + 	(  5 * xyzz ) ) ) ) ;
{
	...
	long  gMYGEN114 = 0 ;
	for (0 ; 	(  	(  gMYGEN114 + 	(  idx * 1 ) ) < load0 ) ; (gMYGEN114 = 	(  gMYGEN114 + 	(  1 * xlen ) )))
	{
	long  iba_tmp = 	(  	(  idx * 1 ) + gMYGEN114 ) ;
	long  numcp = 1 ;
...
}}}}}	double   a_f  [	(  1 * 3 )];0;
{
	...
	double  Midx0 = 	openmp_floorx ( xx0 ) ;
	double  Midy0 = 	openmp_floorx ( xy0 ) ;
	double  Midz0 = 	openmp_floorx ( xz0 ) ;
	double  Midx1 = 	openmp_floorx ( xx1 ) ;
	double  Midy1 = 	openmp_floorx ( xy1 ) ;
	double  Midz1 = 	openmp_floorx ( xz1 ) ;
	...
	{
{
	...
	double  xy2 = Y2 ;
	double  xz2 = Z2 ;
	int  Midx2 = 	openmp_floorx ( xx2 ) ;
	int  Midy2 = 	openmp_floorx ( xy2 ) ;
	int  Midz2 = 	openmp_floorx ( xz2 ) ;
	...
	int  total_idx = 	(  3 * 	(  5 * 	(  xyzy + 	(  5 * xyzz ) ) ) ) ;
{
	...
	long  gMYGEN127 = 0 ;
	for (0 ; 	(  	(  gMYGEN127 + 	(  idx * 1 ) ) < load0 ) ; (gMYGEN127 = 	(  gMYGEN127 + 	(  1 * xlen ) )))
	{
	long  iba_tmp = 	(  	(  idx * 1 ) + gMYGEN127 ) ;
	long  numcp = 1 ;
	double   local_particle_head  [	(  1 * 6 )];{
{
	long  inner_step ;
