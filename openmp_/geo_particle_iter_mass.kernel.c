	...
	int  cu_load = (cu_xyzw)[	(  4 * allgid )] ;
{
	...
	int  Midx = 	openmp_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[0] ) ;
	int  Midy = 	openmp_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[1] ) ;
	int  Midz = 	openmp_mass_floorx ( (	(  cu_cache + 	(  	(  allgid * 	(  6 * cu_cache_length ) ) + 	(  l1 * 6 ) ) ))[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
...
((	(  LFoutJ + 	(  	(  375 * 	(  idy * 	(  	(  XLEN + 	(  2 * ovlp ) ) * 	(  	(  YLEN + 	(  2 * ovlp ) ) * 	(  ZLEN + 	(  2 * ovlp ) ) ) ) ) ) + 	(  0 + 	(  375 * 	(  	(  Midx + ovlp ) + 	(  	(  XLEN + 	(  2 * ovlp ) ) * 	(  	(  Midy + ovlp ) + 	(  	(  YLEN + 	(  2 * ovlp ) ) * 	(  Midz + ovlp ) ) ) ) ) ) ) ) ))[Gll_P9918] = (shJ0)[Gll_P9918]);
	...
	double  grid_geo_z = 	(  DELTA_Z / 	(  DELTA_X * DELTA_Y ) ) ;
	double  XO = (xoffset)[idy] ;
	int  Midx = 	openmp_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[0] ) ;
	int  Midy = 	openmp_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[1] ) ;
	int  Midz = 	openmp_mass_floorx ( (	(  inoutput + 	(  0 + 	(  6 * 	(  allgid * grid_cache_len ) ) ) ))[2] ) ;
	int  Bidx = 	(  Midx - 2 ) ;
	int  Bidy = 	(  Midy - 2 ) ;
	int  Bidz = 	(  Midz - 2 ) ;
	double  Mass = 1.00000000000000000e+00 ;
