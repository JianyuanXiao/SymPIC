...
SWMHCCFLAG=-host
LOCALPROG=sympic
sources= space_filling_curve.o init_adjoint_relation.o split_shell.o init_field3d_mpi.o genrand.o init_particle.o sort_particle.o checkpoint.o run_particle.o pass_xyzzyx.o mpifields.o call_curl_kernel.o blas_shell.o field_sync_h2d_d2h.o sync_fields.o smalllib.o mpi_fieldio.o main.o
$(LOCALPROG)	:$(sources)
